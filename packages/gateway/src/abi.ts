...
export const abi: string[] = [
  ...
  'function setText(bytes32 node, string calldata key, string calldata value) returns (bytes32, bytes32)',
  ...
  'function register(bytes calldata name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] calldata data, bool reverseRecord, uint16 fuses, bytes memory extraData) returns (string memory,bytes32, bytes32, bytes[] memory)',
